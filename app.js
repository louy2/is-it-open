...
/***/ function(module, exports, __webpack_require__) {
	...
	var dataRes = __webpack_require__(3);
...
/***/ function(module, exports) {
	...
	module.exports = "{\n    \"restaurants\": [\n        {\n            \"name\": \"Campus Dining Center\",\n            \"openDuring\": {\n                \"Mon\": [[7, 30], [20, 0]],\n                \"Tue\": [[7, 30], [20, 0]],\n                \"Wed\": [[7, 30], [20, 0]],\n                \"Thu\": [[7, 30], [20, 0]],\n                \"Fri\": [[7, 30], [20, 0]],\n                \"Sat\": [[10, 30], [20, 0]],\n                \"Sun\": [[10, 30], [20, 0]]\n            }\n        },\n        {\n            \"name\": \"Panthers' Den\",\n            \"description\": \"Featuring Nathans and Sonos\",\n            \"openDuring\": {\n                \"Mon\": [[11, 0], [23, 0]],\n                \"Tue\": [[11, 0], [23, 0]],\n                \"Wed\": [[11, 0], [23, 0]],\n                \"Thu\": [[11, 0], [23, 0]],\n                \"Fri\": [[11, 0], [15, 0]],\n                \"Sun\": [[11, 0], [15, 0]]\n            }\n        },\n        {\n            \"name\": \"Mondos Deli\",\n            \"description\": \"Featuring Boars Head\",\n            \"openDuring\": {\n                \"Mon\": [[11, 0], [21, 0]],\n                \"Tue\": [[11, 0], [21, 0]],\n                \"Wed\": [[11, 0], [21, 0]],\n                \"Thu\": [[11, 0], [21, 0]]\n            }\n        },\n        {\n            \"name\": \"Take Out Window\",\n            \"openDuring\": {\n                \"Mon\": [[11, 0], [26, 0]],\n                \"Tue\": [[11, 0], [26, 0]],\n                \"Wed\": [[11, 0], [26, 0]],\n                \"Thu\": [[11, 0], [26, 0]],\n                \"Fri\": [[10, 30], [20, 0]],\n                \"Sat\": [[10, 30], [20, 0]],\n                \"Sun\": [[10, 30], [20, 0]]\n            }\n        },\n        {\n            \"name\": \"The Atrium Cafe\",\n            \"openDuring\": {\n            }\n        },\n        {\n            \"name\": \"Dunkin Donuts\",\n            \"description\": \"Located in the New Academic Building\",\n            \"openDuring\": {\n                \"Mon\": [[7, 30], [20, 0]],\n                \"Tue\": [[7, 30], [20, 0]],\n                \"Wed\": [[7, 30], [20, 0]],\n                \"Thu\": [[7, 30], [20, 0]],\n                \"Fri\": [[7, 30], [14, 0]]\n            }\n        }\n    ]\n}"
...
/***/ function(module, exports) {
	...
	var _user$project$Main$fromDateToDateSpec = function (date) {
		return A3(
	...
	var _user$project$Main$getOpSpecOnDate = F2(
		function (cdate, oph) {
			return _elm_lang$core$Native_Utils.eq(
				_elm_lang$core$Date$dayOfWeek(cdate),
				_elm_lang$core$Date$Mon) ? oph.mon : (_elm_lang$core$Native_Utils.eq(
				_elm_lang$core$Date$dayOfWeek(cdate),
				_elm_lang$core$Date$Tue) ? oph.tue : (_elm_lang$core$Native_Utils.eq(
				_elm_lang$core$Date$dayOfWeek(cdate),
				_elm_lang$core$Date$Wed) ? oph.wed : (_elm_lang$core$Native_Utils.eq(
				_elm_lang$core$Date$dayOfWeek(cdate),
				_elm_lang$core$Date$Thu) ? oph.thu : (_elm_lang$core$Native_Utils.eq(
				_elm_lang$core$Date$dayOfWeek(cdate),
				_elm_lang$core$Date$Fri) ? oph.fri : (_elm_lang$core$Native_Utils.eq(
				_elm_lang$core$Date$dayOfWeek(cdate),
				_elm_lang$core$Date$Sat) ? oph.sat : (_elm_lang$core$Native_Utils.eq(
				_elm_lang$core$Date$dayOfWeek(cdate),
				_elm_lang$core$Date$Sun) ? oph.sun : _elm_lang$core$Maybe$Nothing))))));
		});
	var _user$project$Main$isOpenToday = F2(
		function (cdate, oph) {
			return _elm_lang$core$Basics$not(
				_elm_lang$core$Native_Utils.eq(
					A2(_user$project$Main$getOpSpecOnDate, cdate, oph),
					_elm_lang$core$Maybe$Nothing));
		});
	var _user$project$Main$isOpenNow = F2(
		function (cdate, oph) {
			var todaySpec = _user$project$Main$fromDateToDateSpec(cdate);
			var _p0 = A2(_user$project$Main$getOpSpecOnDate, cdate, oph);
			if (_p0.ctor === 'Nothing') {
				return false;
			} else {
				return A3(
					_justinmimbs$elm_date_extra$Date_Extra$isBetween,
					A3(_justinmimbs$elm_date_extra$Date_Extra$fromSpec, _justinmimbs$elm_date_extra$Date_Extra$local, _p0._0._0, todaySpec),
					A3(_justinmimbs$elm_date_extra$Date_Extra$fromSpec, _justinmimbs$elm_date_extra$Date_Extra$local, _p0._0._1, todaySpec),
					cdate);
			}
		});
	var _user$project$Main$showIsOpenNow = F2(
		function (cdate, oph) {
			var txt = A2(_user$project$Main$isOpenNow, cdate, oph) ? 'Open' : 'Close';
			return A2(
	...
	var _user$project$Main$showRestaurant = F2(
		function (cdate, res) {
			var description = function () {
				var _p1 = res.description;
				if (_p1.ctor === 'Just') {
					return A2(
						_elm_lang$html$Html$p,
						_elm_lang$core$Native_List.fromArray(
			...
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(res.name)
							])),
						description,
						A2(_user$project$Main$showIsOpenNow, cdate, res.opHours)
					]));
		});
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(
						_elm_lang$core$List$map,
						_user$project$Main$showRestaurant(model.date),
						model.list))
				]));
	};
		...
		function (msg, model) {
			...
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						date: _elm_lang$core$Date$fromTime(_p2._0)
					}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		});
	var _user$project$Main$timeSpecHourMinute = F2(
		function (hr, min) {
			return A4(_justinmimbs$elm_date_extra$Date_Extra$atTime, hr, min, 0, 0);
		});
	var _user$project$Main$timeSpecDec = A3(_elm_lang$core$Json_Decode$tuple2, _user$project$Main$timeSpecHourMinute, _elm_lang$core$Json_Decode$int, _elm_lang$core$Json_Decode$int);
	var _user$project$Main$getData = function (_p3) {
		return A2(
			...
			A2(
				...
				_elm_lang$core$Debug$log('Parse Error'),
				_p3));
	};
	var _user$project$Main$newModel = {
		list: _elm_lang$core$Native_List.fromArray(
			[]),
		date: _elm_lang$core$Date$fromTime(0.0),
		dataRes: ''
	};
	var _user$project$Main$Model = F3(
		function (a, b, c) {
			return {list: a, date: b, dataRes: c};
		});
	var _user$project$Main$Restaurant = F3(
		function (a, b, c) {
			return {name: a, description: b, opHours: c};
		});
	var _user$project$Main$OpHours = F7(
		function (a, b, c, d, e, f, g) {
			return {mon: a, tue: b, wed: c, thu: d, fri: e, sat: f, sun: g};
		});
	var _user$project$Main$opHourDec = A8(
		_elm_lang$core$Json_Decode$object7,
		_user$project$Main$OpHours,
		_elm_lang$core$Json_Decode$maybe(
			A2(
				...
				A3(
					...
					_user$project$Main$timeSpecDec,
					_user$project$Main$timeSpecDec))),
		_elm_lang$core$Json_Decode$maybe(
			A2(
				_elm_lang$core$Json_Decode_ops[':='],
		...
		_elm_lang$core$Json_Decode$maybe(
			A2(
				...
				A3(
					...
					_user$project$Main$timeSpecDec,
					_user$project$Main$timeSpecDec))));
	var _user$project$Main$restrDec = A4(
		...
		A2(_elm_lang$core$Json_Decode_ops[':='], 'openDuring', _user$project$Main$opHourDec));
	var _user$project$Main$dataDec = A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'restaurants',
		_elm_lang$core$Json_Decode$list(_user$project$Main$restrDec));
	...
	var _user$project$Main$getTimeNow = A3(_elm_lang$core$Task$perform, _user$project$Main$Tick, _user$project$Main$Tick, _elm_lang$core$Time$now);
	var _user$project$Main$init = function (flags) {
		return A2(
			...
			_elm_lang$core$Native_Utils.update(
				...
				{
					list: _user$project$Main$getData(
						A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Main$dataDec, flags.dataRes))
				}),
			_elm_lang$core$Native_List.fromArray(
				[_user$project$Main$getTimeNow]));
	};
	...
	var _user$project$Main$main = {
		...
		flags: A2(
			...
			A2(_elm_lang$core$Json_Decode_ops[':='], 'dataRes', _elm_lang$core$Json_Decode$string),
			function (dataRes) {
